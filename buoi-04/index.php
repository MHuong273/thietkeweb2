<?php
$pageTitle = "Buổi 4: Mảng (Array) & Các hàm xử lý Chuỗi/Mảng trong PHP";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 04</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 4 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
