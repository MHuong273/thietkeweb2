<?php
$pageTitle = "Buổi 9: Tổng kết học phần, Đồ án môn học & Báo cáo";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 09</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 9 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
