<?php
$pageTitle = "Buổi 7: Kết nối Cơ sở dữ liệu MySQL với PDO / MySQLi";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 07</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 7 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
