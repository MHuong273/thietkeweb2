<?php
$pageTitle = "Buổi 5: Xử lý Form HTML (GET & POST) & Validation trong PHP";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 05</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 5 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
