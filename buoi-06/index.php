<?php
$pageTitle = "Buổi 6: Quản lý Session, Cookie & Authentication trong PHP";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 06</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 6 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
