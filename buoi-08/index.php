<?php
$pageTitle = "Buổi 8: Xây dựng ứng dụng CRUD (Create, Read, Update, Delete)";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 08</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 8 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
