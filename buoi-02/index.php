<?php
$pageTitle = "Buổi 2: Cú pháp cơ bản PHP, Biến, Kiểu dữ liệu & Toán tử";
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
    <div class="card">
        <span class="tag">BÀI THỰC HÀNH 02</span>
        <h1><?= $pageTitle ?></h1>
        <p>Đây là bài tập thực hành dành cho buổi 2 thuộc học phần <strong>Lập trình Web_B1</strong>.</p>
